  ...
  <div>
    ...
    >
      <div class="flex items-center ml-6">
        <button
          type="button"
          class="rounded-full bg-black p-[1px] cursos pointer"
        >
          <ChevronLeft fillColor="#FFFFFF" :size="30" />
        </button>
        <button
          type="button"
          class="rounded-full bg-black p-[1px] ml-4 cursos pointer"
        >
      ...
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27"
            src="https://yt3.ggpht.com/yti/AHyvSCC14ypv2W8i1VjWIzeNNRYLcxL0QwYRQbOgG64Yew=s88-c-k-c0x00ffffff-no-rj-mo"
            alt="Profile Picture"
          />
      ...
      <span
        v-if="openMenu"
        class="fixed w-[190p] bg-[#282828] shadow-2l z-50 rounded-sm top-[52px] right-[35px] p-1 cursor-pointer"
      >
        <ul class="text-gray-200 font-semibold text-[14p]">
          <li class="p-3 py-2.5 hover:bg-[#3E3D3D] border-b border-b-gray-600">
            Profile
          </li>
          <li class="p-3 py-2.5 hover:bg-[#3E3D3D]">Log out</li>
        </ul>
      </span>
    </div>
      ...
      <div class="my-8">
        ...
        <ul>
          <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">
            My Playlist #1
          </li><li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">
            My Playlist #2
          </li><li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">
            My Playlist #3
          </li><li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">
