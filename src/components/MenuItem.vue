...
// Sirve para que los iconos cambien de estado activo a inactivo con solo hacer que las rutas coincidan
watchEffect(() => {
...
<template>
    <li class="flex items-center justify-start pb-4 cursor-pointer" @mouseenter="inHover()" @mouseleave="inHover()">
